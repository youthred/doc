const o={docsHtml:`<p><code>prompt</code> 函数是对 <a href="https://cdn.w3cbus.com/zh-cn/docs/2/components/dialog"><code>&lt;mdui-dialog&gt;</code></a> 组件的封装，该函数在功能上用于代替系统原生的 <code>window.prompt</code> 函数。使用该函数，你无需编写组件的 HTML 代码，就能打开一个可输入文本的对话框。</p>
<h2 id="usage">
                  <a href="#usage">使用方法</a>
                </h2>
<p>按需导入函数：</p>
...
<p>函数的参数为 <a href="#api-options">Options</a> 对象；返回值为 Promise，如果是通过点击确定按钮关闭对话框，则 Promise 会被 resolve，resolve 的参数为输入框的值，如果是通过其他方式关闭对话框，则 Promise 会被 reject。</p>
<h3 id="api-options">
  ...
  <tbody>
    ...
    <tr>
      <td colspan="3">
        ...
        <p><a href="https://cdn.w3cbus.com/zh-cn/docs/2/functions/dialog"><code>dialog()</code></a>、<a href="https://cdn.w3cbus.com/zh-cn/docs/2/functions/alert"><code>alert()</code></a>、<a href="https://cdn.w3cbus.com/zh-cn/docs/2/functions/confirm"><code>confirm()</code></a>、<code>prompt()</code> 这四个函数的队列名称若相同，则也将互相共用同一个队列。</p>
      </td>
    </tr>
    <tr id="options-onConfirm">
      <td><a href="#options-onConfirm"><code>onConfirm</code></a></td>
      <td><code>(value: string, dialog: <a href="https://cdn.w3cbus.com/zh-cn/docs/2/components/dialog">Dialog</a>) => void | boolean | Promise&lt;void&gt;</code></td>
      <td>-</td>
    </tr>
    <tr>
      <td colspan="3">
    ...
    <tr id="options-textFieldOptions">
      ...
      <td><code>Partial&lt;<a href="https://cdn.w3cbus.com/zh-cn/docs/2/components/text-field#attributes">TextField</a>&gt;</code></td>
      <td>-</td>
    </tr>
    <tr>
      <td colspan="3">prompt 内部的输入框为 <a href="https://cdn.w3cbus.com/zh-cn/docs/2/components/text-field"><code>&lt;mdui-text-field&gt;</code></a> 组件。可在该参数中设置 <a href="https://cdn.w3cbus.com/zh-cn/docs/2/components/text-field"><code>&lt;mdui-text-field&gt;</code></a> 组件的参数。</td>
    </tr>
  </tbody>
</table>
