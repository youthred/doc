const e={docsHtml:`<p>按钮主要用于执行一些操作，例如发送邮件、分享文档或点赞评论等。</p>
<h2 id="usage">
                  <a href="#usage">使用方法</a>
                </h2>
<p>按需导入组件：</p>
...
<p>使用 <code>variant</code> 属性设置按钮的形状。</p>
...
<h3 id="example-full-width">
                  <a href="#example-full-width">全宽</a>
                </h3>
<p>添加 <code>full-width</code> 属性可以使按钮显示为块状元素，即占据全部宽度。</p>
<pre><code class="language-html,example,expandable">&lt;mdui-button full-width&gt;Button&lt;/mdui-button&gt;
</code></pre>
<h3 id="example-icon">
                  <a href="#example-icon">图标</a>
                </h3>
<p>设置 <code>icon</code>、<code>end-icon</code> 属性，可以分别在按钮左侧、右侧添加 Material Icons 图标。也可以通过 <code>icon</code>、<code>end-icon</code> slot 在按钮左侧、右侧添加元素。</p>
...
<p>设置 <code>href</code> 属性，可以使按钮变为链接，此时还可以使用这些和链接相关的属性：<code>download</code>、<code>target</code>、<code>rel</code>。</p>
...
<p>添加 <code>disabled</code> 属性可以禁用按钮；添加 <code>loading</code> 属性可以为按钮添加加载中状态。</p>
...
`,elements:[{name:"Button",tagName:"mdui-button",summary:`<p>按钮组件</p>
<pre><code class="language-html">&lt;mdui-button&gt;Button&lt;/mdui-button&gt;
</code></pre>
`,attributes:[{attributeName:"variant",propertyName:"variant",reflect:!0,description:`<p>按钮的形状。可选值包括：</p>
<ul>
...
`,type:"'elevated' | 'filled' | 'tonal' | 'outlined' | 'text'",enum:["'elevated'","'filled'","'tonal'","'outlined'","'text'"],default:"'filled'"},{attributeName:"full-width",propertyName:"fullWidth",reflect:!0,description:`<p>是否填满父元素宽度</p>
...
`}],slots:[{name:"",description:`<p>按钮的文本</p>
`},{name:"icon",description:`<p>按钮左侧的元素</p>
`},{name:"end-icon",description:`<p>按钮右侧的元素</p>
`}],cssParts:[{name:"button",description:`<p>内部的 <code>&lt;button&gt;</code> 或 <code>&lt;a&gt;</code> 元素</p>
`},{name:"label",description:`<p>按钮的文本</p>
`},{name:"icon",description:`<p>按钮左侧的图标</p>
`},{name:"end-icon",description:`<p>按钮右侧的图标</p>
