const o={docsHtml:`<p><code>configm</code> 函数是对 <a href="https://cdn.w3cbus.com/zh-cn/docs/2/components/dialog"><code>&lt;mdui-dialog&gt;</code></a> 组件的封装，该函数在功能上用于代替系统原生的 <code>window.confirm</code> 函数。使用该函数，你无需编写组件的 HTML 代码，就能打开一个确认框。</p>
<h2 id="usage">
                  <a href="#usage">使用方法</a>
                </h2>
<p>按需导入函数：</p>
...
<p>函数接收一个 <a href="#api-options">Options</a> 对象作为参数；返回值为 Promise，如果通过点击确定按钮关闭，则 Promise 会被 resolve，如果通过其他方式关闭，则 Promise 会被 reject。</p>
<h3 id="api-options">
  ...
  <tbody>
    ...
    <tr>
      <td colspan="3">
        ...
        <p><a href="https://cdn.w3cbus.com/zh-cn/docs/2/functions/dialog"><code>dialog()</code></a>、<a href="https://cdn.w3cbus.com/zh-cn/docs/2/functions/alert"><code>alert()</code></a>、<code>confirm()</code>、<a href="https://cdn.w3cbus.com/zh-cn/docs/2/functions/prompt"><code>prompt()</code></a> 这四个函数的队列名称若相同，则也将互相共用同一个队列。</p>
      </td>
    </tr>
