const e={docsHtml:`<p>The Floating Action Button (FAB) is a primary component for key actions, offering easy access.</p>
<h2 id="usage">
...
<p>Set the Material Icon name with the <code>icon</code> attribute or use the <code>icon</code> slot.</p>
...
<h3 id="example-extended">
                  <a href="#example-extended">Extended State</a>
                </h3>
<p>Use <code>extended</code> to display text from the default slot in the extended state.</p>
...
<p>Set the FAB shape with the <code>variant</code> attribute.</p>
...
<h3 id="example-size">
                  <a href="#example-size">Size</a>
                </h3>
<p>Set the FAB size with the <code>size</code> attribute.</p>
...
<p>Use the <code>href</code> attribute to turn the FAB into a link. The <code>download</code>, <code>target</code>, and <code>rel</code> attributes are available for link-related functionality.</p>
...
<p>Use <code>disabled</code> to disable the FAB. Use <code>loading</code> to add a loading state.</p>
...
`,elements:[{name:"Fab",tagName:"mdui-fab",summary:`<p>Floating Action Button Component.</p>
<pre><code class="language-html">&lt;mdui-fab icon=&quot;edit&quot;&gt;&lt;/mdui-fab&gt;
</code></pre>
`,attributes:[{attributeName:"variant",propertyName:"variant",reflect:!0,description:`<p>Sets the FAB color. Possible values:</p>
<ul>
...
`,type:"'primary' | 'surface' | 'secondary' | 'tertiary'",enum:["'primary'","'surface'","'secondary'","'tertiary'"],default:"'primary'"},{attributeName:"size",propertyName:"size",reflect:!0,description:`<p>Sets the FAB size. Possible values:</p>
<ul>
<li><code>normal</code>: Sets the FAB to a normal size.</li>
<li><code>small</code>: Sets the FAB to a small size.</li>
<li><code>large</code>: Sets the FAB to a large size.</li>
</ul>
`,type:"'normal' | 'small' | 'large'",enum:["'normal'","'small'","'large'"],default:"'normal'"},{attributeName:"icon",propertyName:"icon",reflect:!0,description:`<p>Sets the Material Icons name. Alternatively, use <code>slot=&quot;icon&quot;</code>.</p>
`,type:"string",enum:[]},{attributeName:"extended",propertyName:"extended",reflect:!0,description:`<p>Indicates if the FAB is in the extended state.</p>
...
`,parameters:[{name:"message",type:"string"}],return:{type:"void"}}],events:[{name:"focus",description:`<p>Emitted when the FAB gains focus.</p>
`},{name:"blur",description:`<p>Emitted when the FAB loses focus.</p>
...
`},{name:"label",description:`<p>Text on the right side.</p>
...
`}],cssProperties:[{name:"--shape-corner-small",description:`<p>The size of the component corner when <code>size=&quot;small&quot;</code>. You can use a specific pixel value, but it&#39;s recommended to reference <a href="https://cdn.w3cbus.com/docs/2/styles/design-tokens#shape-corner">design tokens</a>.</p>
`},{name:"--shape-corner-normal",description:`<p>The size of the component corner when <code>size=&quot;normal&quot;</code>. You can use a specific pixel value, but it&#39;s recommended to reference <a href="https://cdn.w3cbus.com/docs/2/styles/design-tokens#shape-corner">design tokens</a>.</p>
`},{name:"--shape-corner-large",description:`<p>The size of the component corner when <code>size=&quot;large&quot;</code>. You can use a specific pixel value, but it&#39;s recommended to reference <a href="https://cdn.w3cbus.com/docs/2/styles/design-tokens#shape-corner">design tokens</a>.</p>
`}]}]};export{e as default};
